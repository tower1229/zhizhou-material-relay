...
var ColorfulTable = /*#__PURE__*/function (_React$Component) {
      ...
      case 'IMAGE':
        return text ? text.map(function (item, index) {
          return (
            ...
            //   <a href={`${baseApi}/api/v1/attach?objectApiName=${item.objectApiName}&columnApiName=${item.columnApiName}&dataId=${item.dataId}&fileId=${item.fileId}`}  >{item.originalFilename}</a>
            // </div>
            React.createElement("div", null, /*#__PURE__*/React.createElement(_Image, {
              width: 200,
              src: baseApi + "/api/v1/attach?objectApiName=" + item.objectApiName + "&columnApiName=" + item.columnApiName + "&dataId=" + item.dataId + "&fileId=" + item.fileId
            }))
          );
        }) : '';
  ...
  /*#__PURE__*/
  function () {
    var _btnLineClick = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(value) {
      var _this5 = this;
  ...
  /*#__PURE__*/
  function () {
    var _confirmDataBatch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6() {
  ...
  _proto.enableDataBatch = /*#__PURE__*/function () {
    var _enableDataBatch2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(enabled) {
      var itemList, selectedRowKeys, mainObjectApiName, res;
