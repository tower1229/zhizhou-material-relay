...
import "./index.scss";
import moment from 'moment'; // import { Input } from '@alifd/next';

var TextArea = _Input.TextArea; // import { createFromIconfontCN } from '@ant-design/icons';
...
import { getPagesList, addPages, metaInfo, dataTable } from "../../api/pages";
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              handleSave(_extends({}, record, values)); // toggleEdit();
  ...
  switch (columnType) {
    ...
    case 'SINGLE_CHOICE':
      childNode = /*#__PURE__*/React.createElement(_Form.Item, {
        ...
        value: 1
      }, "A"), /*#__PURE__*/React.createElement(_Radio, {
        value: 2
      }, "B"), /*#__PURE__*/React.createElement(_Radio, {
        value: 3
      }, "C"), /*#__PURE__*/React.createElement(_Radio, {
        value: 4
      }, "D")));
      break;
    ...
    case 'FILE':
      childNode = /*#__PURE__*/React.createElement(_Form.Item, {
        ...
        name: dataIndex,
        rules: []
      }, /*#__PURE__*/React.createElement(_Upload, props, /*#__PURE__*/React.createElement(_Button, null, "\u4E0A\u4F20\u6587\u4EF6")));
      break;
...
var ColorfulForm = function ColorfulForm(_ref5) {
  var color = _ref5.color,
    ...
    entity: []
      ...
      otherProps = _objectWithoutPropertiesLoose(_ref5, _excluded3);
      ...
      if (values[_i]) {
        ...
        result.forEach(function (element) {
          if (element.apiName == _i) {
            ...
            values[_i] = moment(values[_i]).format('YYYY-MM-DD HH:mm:ss');
          }
        });
  ...
  var realationClick = function realationClick(item) {
    ...
    dataTable(data).then(function (res) {
  ...
  var testMessage = function testMessage(value) {
    ...
    switch (type) {
      ...
      case 2:
        _message.info("" + value[0].triggeredContent);
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    React.createElement("div", {
      ...
      className: "realation-left"
    }, form.getFieldValue(i.apiName)), /*#__PURE__*/React.createElement("div", null, "+")) : i.columnType === 'BOOL' ? /*#__PURE__*/React.createElement(_Switch, {
      onChange: onChange
    }) : i.columnType === 'SINGLE_CHOICE' ? /*#__PURE__*/React.createElement(_Radio.Group, {
      ...
      value: 4
    }, "D")) : i.columnType === 'SINGLE_CHOICE_TREE' ? /*#__PURE__*/React.createElement(_Select, {
      defaultValue: "",
      style: {
        width: 120
      },
      ...
      value: "Yiminghe"
    }, "yiminghe")) : i.columnType === 'MULTI_CHOICE' ? /*#__PURE__*/React.createElement(_Checkbox.Group, {
      options: plainOptions,
      defaultValue: ['Apple'],
      onChange: onCheckChange
    }) : i.columnType === 'MULTI_CHOICE_TREE' ? /*#__PURE__*/React.createElement(_Select, {
      mode: "multiple",
      allowClear: true,
      style: {
        width: '100%'
    ...
    }, children) : i.columnType === 'INTEGER' ? /*#__PURE__*/React.createElement(_InputNumber, {
      min: -99999999999,
      max: 99999999999,
      precision: 0
      ...
      maxLength: 18,
      placeholder: "\u8BF7\u586B\u5199\u8EAB\u4EFD\u8BC1\u53F7\u7801"
    }) : i.columnType === 'FILE' ? /*#__PURE__*/React.createElement(_Upload, props, /*#__PURE__*/React.createElement(_Button, null, "Click to Upload")) : i.columnType === 'WEBSITE' ? /*#__PURE__*/React.createElement(_Input, {
      placeholder: "\u8BF7\u586B\u5199\u7F51\u5740"
    ...
    return i.actionList[0].type == 0 ? /*#__PURE__*/React.createElement(_Popconfirm, {
      title: "\u662F\u5426\u786E\u8BA4\u63D0\u4EA4\uFF1F",
      okText: "Yes",
      cancelText: "No",
      onConfirm: confirmProp,
      onCancel: cancelProp
    }, Btn) : i.actionList[0].type == 2 ? /*#__PURE__*/React.createElement(_Tooltip, {
      placement: "topLeft",
      title: i.tooltip
    ...
    type: "primary",
    htmlType: "submit"
  }, "\u63D0\u4EA4"), /*#__PURE__*/React.createElement(_Button, {
    className: "btn"
  }, "\u91CD\u7F6E"))))));
};
