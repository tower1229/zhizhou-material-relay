...
import ColorfulDialog from "../../components/colorful-dialog/index"; // import { UploadOutlined } from '@ant-design/icons';
...
var ColorfulForm = function ColorfulForm(_ref4) {
  var color = _ref4.color,
    ...
    zIndex: 6
      ...
      otherProps = _objectWithoutPropertiesLoose(_ref4, _excluded3);
  ...
  var Option = _Select.Option; //   const handleChange = (value: any) => {
  ...
  var getPagesListFuc = function getPagesListFuc(params) {
    ...
    getPagesList(params).then(function (res) {
      console.log(res);
    });
  };
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "btn"
  }, "\u91CD\u7F6E")))), /*#__PURE__*/React.createElement(ColorfulDialog, {
    getShow: getShow,
    getUser: getUser,
    columns: columns,
    tableData: tableData,
