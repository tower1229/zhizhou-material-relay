...
var ColorfulTable = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.getLineData = function getLineData(type, text) {
    // console.log('text1111', type, text);
    // return 'ddddd'
    switch (type) {
      case 'SINGLE_CHOICE':
      ...
      case 'FILE':
        ...
        return text ? text.map(function (item, index) {
          return (
            /*#__PURE__*/
            // <div>
            //   <a href={`${baseApi}/api/v1/attach?objectApiName=${item.objectApiName}&columnApiName=${item.columnApiName}&dataId=${item.dataId}&fileId=${item.fileId}`}  >{item.originalFilename}</a>
            // </div>
      ...
      case 'IMAGE':
        return text ? text.map(function (item, index) {
          return (
            ...
            //   <a href={`${baseApi}/api/v1/attach?objectApiName=${item.objectApiName}&columnApiName=${item.columnApiName}&dataId=${item.dataId}&fileId=${item.fileId}`}  >{item.originalFilename}</a>
            // </div>
            React.createElement("div", null, /*#__PURE__*/React.createElement(_image["default"], {
              width: 200,
              src: _index2.baseApi + "/api/v1/attach?objectApiName=" + item.objectApiName + "&columnApiName=" + item.columnApiName + "&dataId=" + item.dataId + "&fileId=" + item.fileId
            }))
          );
        }) : '';
      ...
      case 'MULTI_CHOICE_TREE':
        return text ? text.map(function (item, index) {
          return (
            ...
            //   <a href={`${baseApi}/api/v1/attach?objectApiName=${item.objectApiName}&columnApiName=${item.columnApiName}&dataId=${item.dataId}&fileId=${item.fileId}`}  >{item.originalFilename}</a>
            // </div>
            React.createElement("span", null, item.name, index < text.length - 1 && ',')
          );
        }) : '';
      ...
      itemList.entityList.forEach(function (col) {
        ...
        var obj = {
          ...
          render: function render(text, record, index) {
            return /*#__PURE__*/React.createElement("div", null, _this4.getLineData(col.columnType, text));
          }
        };
        arrColumn.push(obj);
      });
  ...
  /*#__PURE__*/
  function () {
    var _btnLineClick = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(value) {
      var _this5 = this;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              type = info.type;
              _context5.t0 = type;
              _context5.next = _context5.t0 === 0 ? 7 : _context5.t0 === 1 ? 26 : _context5.t0 === 2 ? 28 : _context5.t0 === 4 ? 30 : _context5.t0 === 5 ? 33 : 35;
              break;
  ...
  /*#__PURE__*/
  function () {
    var _confirmDataBatch = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6() {
  ...
  _proto.enableDataBatch = /*#__PURE__*/function () {
    var _enableDataBatch2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7(enabled) {
      var itemList, selectedRowKeys, mainObjectApiName, res;
