...
var ColorfulIframe = function ColorfulIframe(props) {
  ...
  return /*#__PURE__*/React.createElement(_iframe["default"], {
    src: props.url,
    width: "100%",
    height: props.autoHeight ? '100%' : ((_props$offset = props.offset) === null || _props$offset === void 0 ? void 0 : _props$offset.height) || 500,
    style: {
      marginTop: props.autoHeight ? 0 : (((_props$offset2 = props.offset) === null || _props$offset2 === void 0 ? void 0 : _props$offset2.marginTop) || 0) + "px"
    }
  });
};
